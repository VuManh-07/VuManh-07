...
<table>
  <tr>
    ...
    <td align="center" valign="top" width="33%" style="background:#0d1117;border-radius:16px;padding:16px;vertical-align:top;border:1px solid #1f2937;">
      ...
      <h3 style="color:#80FFDB;">🎯 Hobby</h3>
      <p align="left" style="color:#c9d1d9;font-size:14px;min-height:100px;">
...
<table align="center" width="100%" style="border-collapse:separate;border-spacing:20px 20px;">
  <tr align="center">
    ...
    <td width="33%" valign="top">
      <div style="background:#fff;border:1px solid #d0d7de;border-radius:12px;overflow:hidden;max-width:320px;margin:auto;">
        <img src="./api_micro.jpeg" width="100%" height="160" style="object-fit:cover;border-top-left-radius:12px;border-top-right-radius:12px;">
        <div style="padding:16px;">
  ...
  <tr align="center">
    ...
    <td width="33%" valign="top">
      <div style="background:#fff;border:1px solid #d0d7de;border-radius:12px;overflow:hidden;max-width:320px;margin:auto;">
        <img src="./clean_code.jpg" width="100%" height="140" style="object-fit:cover;border-top-left-radius:12px;border-top-right-radius:12px;">
        <div style="padding:16px;">
